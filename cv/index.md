...
| `aerovision_worker/` | Worker package with settings, logging, device, database, storage path, model runtime, startup, queue, image processing, and video processing modules. |
